package com.iktakademija.Dan0302_RestVezbe.entities;
...
import com.iktakademija.Dan0302_RestVezbe.controllers.BankClientEntities;
...
//		base.removeIf(n -> n.isValid() == false);	
	...
	@RequestMapping(value = "/recnik/{trazena_rec}", method = RequestMethod.GET)
	public String returnRecnik(@PathVariable("trazena_rec") String rec) {
